...
coreHorseShoeLoop <- function(X, Y, mat_x_m1, m1_beta, mu_beta_vb, sig2_beta_vb, tau_vb) {
    invisible(.Call('locus_coreHorseShoeLoop', PACKAGE = 'locus', X, Y, mat_x_m1, m1_beta, mu_beta_vb, sig2_beta_vb, tau_vb))
}
